...
class ClientsScheduledModel {
  ...
  factory ClientsScheduledModel.fromMap(Map<String, dynamic> map) {
    return ClientsScheduledModel(
      ...
      time: map['time'] ?? '',
      charge: map['charge'] ?? '',
      telefone_client: map['telefone_client']?.toString() ?? '', // Conversión segura a String
  ...
  factory ClientsScheduledModel.fromJson(String source) => ClientsScheduledModel.fromMap(json.decode(source));
}

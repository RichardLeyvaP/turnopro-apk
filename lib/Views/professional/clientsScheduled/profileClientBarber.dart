...
class _ProfileClientBarberState extends State<ProfileClientBarber> {
                                          ...
                                          Navigator.push(
                                            ...
                                            MaterialPageRoute(
                                              builder: (context) => ImageDetailScreen(
                                                imageUrl: '${Env.apiEndpoint}/images/$urlImageClient',
                                                description: clientSchedControl.endLookBarber1,
                                              ),
                                            ),
                                          );
                                        },
                        ...
                        child: Column(
                          children: [
                            ...
                            cardOptionsImage(
                              ...
                              clientSchedControl.imageUrlBarber1, // 'CARGAR LA IMAGEN DEL BARBERO',
                            ),
              ...
              Row(
                ...
                children: [
                  Padding(
                    ...
                    child: CircleAvatar(
                      backgroundColor: Colors.white, //color de fondo de la imagen
  ...
  InkWell cardOptionsImage(BuildContext context, icon, title, PagesConfigController pagesConfigCont,
      PageController pageController2, endLook, ultimateBarber, urlImage) {
    return InkWell(
      onTap: () async {
        print('estoy dando click');
      },
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: () {
                                setState(() {
                                  isExpanded = !isExpanded; // Cambia entre expandido y colapsado
                                });
                              },
                              child: Row(
                        ...
                        ExpandableTextWidget(
                          text: clientSchedControl.endLookBarber1,
            ...
            child: ListTile(
              ...
              title: Row(
                ...
                children: [
                  ...
                  SizedBox(width: 6),
                  Expanded(
                    // Aquí también se utiliza Expanded para el texto
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const Row(
                        ...
                        Text(
                          ...
                          overflow: TextOverflow.ellipsis, // Trunca si el texto es largo
                          maxLines: 1, // Limita el texto a una sola línea
                        ),
                      ],
                    ),

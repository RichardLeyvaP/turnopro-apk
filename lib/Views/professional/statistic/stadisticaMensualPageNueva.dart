...
import 'package:turnopro_apk/Utility/DynamicYearButtons.dart';
...
class StadisticaMensualPageNueva extends StatefulWidget {
  ...
  @override
  _StadisticaMensualPageNuevaState createState() => _StadisticaMensualPageNuevaState();
}

class _StadisticaMensualPageNuevaState extends State<StadisticaMensualPageNueva> {
  ...
  void _changeColor() {
    setState(() {
      buttonColor = (buttonColor == const Color(0xFF4470F3)) ? Colors.green : const Color(0xFF4470F3);
    });
  }
                                ...
                                child: Column(
                                  children: [
                                    const Text('Total Pagado',
                                        style:
                                            TextStyle(fontWeight: FontWeight.w700, fontSize: 16, color: Colors.white)),
                ...
                Expanded(
                  ...
                  child: Padding(
                    ...
                    child: Container(
                      ...
                      child: const DynamicYearButtons(),
                    ),
                  ),
                ),
              ],
...
Widget chartToRun(CoexistenceController cControll) {
  ...
  chartData = ChartData(
    ...
    xUserLabels: const ['E', 'F', 'M', 'A', 'M', 'J', 'J', 'A', 'S', 'O', 'N', 'D'],

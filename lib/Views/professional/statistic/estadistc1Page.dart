            ...
            : Column(
                ...
                children: [
                  ...
                  _.chargeSave == 'Tecnico'
                                              ...
                                              decoration: BoxDecoration(
                                                ...
                                                boxShadow: [
                                                  BoxShadow(
                                                    ...
                                                    blurRadius: 5,
                                                    offset: const Offset(
                                                        -5, 5), // Ajusta los valores para personalizar la sombra
                                                  ),
                                                ],
                                                borderRadius:
                                                    const BorderRadius.all(Radius.circular(borderRadiusValue)),
                                              ),
                                              child:
                                                  GetBuilder<ClientsScheduledController>(builder: (controllerClient) {
                                                return ListTile(
                                                                ...
                                                                children: [
                                                                      ...
                                                                      Row(
                                                                        children: [
                                                                          ...
                                                                          Column(
                                                                            ...
                                                                            children: [
                                                                              TruncatedText(
                                                                                text: _.estadist1[index].clientName
                                                                                    .toString(),
                                                                                maxLength: 17,
                                                                  ...
                                                                  Row(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Text(
                                                                        formatNumber(
                                                                            _.estadist1[index].amountTotal.toString()),
                      ...
                      : Expanded(
                          flex: heightFlexBody + 2, // 85% del espacio disponible para esta parte
                          child: _.estadist1Length > 0
                              ? ListView.builder(
                                  padding: EdgeInsets.zero, // Elimina cualquier padding del ListView
                                  itemCount: _.estadist1Length,
                                  itemBuilder: (context, index) {
                                    String servRea = _.estadist1[index].servicesRealizated.toString();
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Row(
                                                                    ...
                                                                    children: [
                                                                      Text('Elección'),
                                                                      Text(
                                                                        _.estadist1[index].choice.toString(),
                                                                        maxLines: 2, // Limita el texto a 2 líneas
                                                                        overflow: TextOverflow
                                                                            .ellipsis, // Agrega los tres puntos suspensivos
                                                                        style: const TextStyle(
                                                                  ...
                                                                  Row(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Text(
                                                                        formatNumber(
                                                                            _.estadist1[index].Services.toString()),
                                                                        maxLines: 2, // Limita el texto a 2 líneas
                                                                        overflow: TextOverflow
                                                                            .ellipsis, // Agrega los tres puntos suspensivos
                                                                        style: const TextStyle(
                                                                  ...
                                                                  Row(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Text(
                                                                        formatNumber(_.estadist1[index].serviceSpecial
                                                                            .toString()),
                                                                        maxLines: 2, // Limita el texto a 2 líneas
                                                                        overflow: TextOverflow
                                                                            .ellipsis, // Agrega los tres puntos suspensivos
                                                                  ...
                                                                  Row(
                                                                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                                    children: [
                                                                      Text('Servicios regulares'),
                                                                      Text(
                                                                        formatNumber(_.estadist1[index].serviceRegular
                                                                            .toString()),
                                                                        maxLines: 2, // Limita el texto a 2 líneas
                                                                        overflow: TextOverflow
                                                                            .ellipsis, // Agrega los tres puntos suspensivos
                                                                  ...
                                                                  Column(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Text(
                                                                        servRea,
                                                                        maxLines: 5, // Limita el texto a 2 líneas
                                                                        overflow: TextOverflow
                                                                            .ellipsis, // Agrega los tres puntos suspensivos
                                                                        style: const TextStyle(
                                                                            fontSize: 16,
                                                                  ...
                                                                  Row(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Text(
                                                                        _.estadist1[index].time.toString(),
                                                                        maxLines: 2, // Limita el texto a 2 líneas
                                                                        overflow: TextOverflow
                                                                            .ellipsis, // Agrega los tres puntos suspensivos
                                                                        style: const TextStyle(
                                                                  ...
                                                                  Row(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Text(
                                                                        formatNumber(
                                                                            _.estadist1[index].Products.toString()),
                                                                        maxLines: 2, // Limita el texto a 2 líneas
                                                                        overflow: TextOverflow
                                                                            .ellipsis, // Agrega los tres puntos suspensivos
                                                                        style: const TextStyle(
                                                                  ...
                                                                  Row(
                                                                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                                    children: [
                                                                      Text('Ganancia Especial'),
                                                                      Text(
                                                                        _.estadist1[index].SpecialAmount.toString(),
                                                                        maxLines: 2, // Limita el texto a 2 líneas
                                                                        overflow: TextOverflow
                                                                            .ellipsis, // Agrega los tres puntos suspensivos
                                                                        style: const TextStyle(
                                                                  ...
                                                                  Row(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Text(
                                                                        _.estadist1[index].totalServices.toString(),
                                                                  ...
                                                                  Row(
                                                                    ...
                                                                    children: [
                                                                      Text('Propina'),
                                                                      Text(
                                                                        _.estadist1[index].tips.toString(),
                                                                        maxLines: 2, // Limita el texto a 2 líneas
                                                                        overflow: TextOverflow
                                                                            .ellipsis, // Agrega los tres puntos suspensivos
                                                                        style: const TextStyle(
                                                                  ...
                                                                  Row(
                                                                    ...
                                                                    children: [
                                                                      Text('Propina 80%'),
                                                                      Text(
                                                                        _.estadist1[index].tips80.toString(),
                                                                  ...
                                                                  Row(
                                                                    ...
                                                                    children: [
                                                                      Text('Retención'),
                                                                      Text(
                                                                        _.estadist1[index].totalRetention.toString(),
                                                                        maxLines: 2, // Limita el texto a 2 líneas
                                                                        overflow: TextOverflow
                                                                            .ellipsis, // Agrega los tres puntos suspensivos
                                                                        style: const TextStyle(
                                                                  ...
                                                                  Row(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Text(
                                                                        _.estadist1[index].winPay.toString(),
                                                                        maxLines: 2, // Limita el texto a 2 líneas
                                                                        overflow: TextOverflow
                                                                            .ellipsis, // Agrega los tres puntos suspensivos
                                                                        style: const TextStyle(

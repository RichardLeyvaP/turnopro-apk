...
class LineChartSample5 extends StatefulWidget {
  const LineChartSample5({
    ...
    Color? indicatorStrokeColor,
            ...
            gradientColor1 ?? const Color.fromARGB(255, 68, 135, 211),
        gradientColor2 =
            gradientColor2 ?? const Color.fromARGB(137, 233, 30, 98),
        gradientColor3 =
            gradientColor3 ?? const Color.fromARGB(174, 244, 67, 54),
        indicatorStrokeColor = indicatorStrokeColor ?? Colors.grey;
...
class _LineChartSample5State extends State<LineChartSample5> {
  ...
  Widget bottomTitleWidgets(double value, TitleMeta meta, double chartWidth) {
    final style = TextStyle(
      ...
      color: const Color.fromARGB(137, 233, 30, 98),
      fontFamily: 'Digital',

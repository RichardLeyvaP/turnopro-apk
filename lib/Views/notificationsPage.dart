                ...
                children: [
                  ...
                  typeEnv != 'Encargado'
                          ...
                          child: _.notificationListLength > 0
                              ? ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    String description = textoCompleto.split(
                                        '.')[0]; // Obtener la descripción
                                    return Padding(
                      ...
                      : Expanded(
                          flex:
                              heightFlexBody, // 85% del espacio disponible para esta parte
                          child: _.notificationListLengthEncarg > 0
                              ? ListView.builder(
                                  padding: EdgeInsets
                                      .zero, // Elimina cualquier padding del ListView
                                  ...
                                  itemBuilder: (context, index) {
                                    String textoCompleto =
                                        _.notificationEncarg[index].description;
                                    String description = textoCompleto.split(
                                        '.')[0]; // Obtener la descripción
                                    return Padding(
                                      padding: EdgeInsets.only(
                                                    ...
                                                    ListTile(
                                                      ...
                                                      title: Row(
                                                        ...
                                                        children: [
                                                              ...
                                                              children: [
                                                                Text(
                                                                  ...
                                                                  style:
                                                                    ...
                                                                    fontSize: _
                                                                            .selectNotification
                                                                            .contains(_.notificationEncarg[index])
                                                                        ? 23
                                                                        : 16,
                                                                    fontWeight:
                                                                        FontWeight
                                                          ...
                                                          (_.notificationEncarg[index].state ==
                                                                      0) ||

...
import 'package:turnopro_apk/components/Header.dart';
import 'package:turnopro_apk/components/BottomNavigationBar.dart';

class ServicesProductsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //final widthTextTitle = (MediaQuery.of(context).size.width / 20);
    return Scaffold(
      backgroundColor: const Color.fromARGB(255, 231, 232, 234),
      body: SafeArea(
          child: structureServicesProducts(valuePadding, context, totalPay)),
